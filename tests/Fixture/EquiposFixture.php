...
class EquiposFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'ciudad' => ['type' => 'string', 'length' => 100, 'null' => true, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        'provincia' => ['type' => 'string', 'length' => 100, 'null' => true, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        'liga_id' => ['type' => 'uuid', 'length' => null, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null],
        ...
        '_indexes' => [
            'liga_key' => ['type' => 'index', 'columns' => ['liga_id'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'equipos_ibfk_1' => ['type' => 'foreign', 'columns' => ['liga_id'], 'references' => ['ligas', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public $records = [
        [
            'id' => 'b1465b2d-14f6-4b1d-8264-e5e909e123d4',
            'nombre' => 'Lorem ipsum dolor sit amet',
            'ciudad' => 'Lorem ipsum dolor sit amet',
            'provincia' => 'Lorem ipsum dolor sit amet',
            'liga_id' => 'df56f646-f795-484f-87c9-b1f9c7bf828c',
            'created' => 1512046377,
            'modified' => 1512046377
        ],
    ];
